...
<body class="site <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " itemid-" . $itemid . " ";?>">
	...
	<div class="container">
		<div id="content">
			...
			<div class="login1">Versiones 3.0 <a href="http://www.joomlaspanish.org" target="_blank">Joomla! Spanish</a> ELITE PRO-1<br /> Pack Profesional Especializado (ES) 2005-<?php echo date('Y');?></div>
			<noscript>
